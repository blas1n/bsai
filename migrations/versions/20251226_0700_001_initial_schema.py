"""Initial schema: 9 tables for agent orchestration

Revision ID: 001
Revises:
Create Date: 2025-12-26 07:00:00.000000
...
def upgrade() -> None:
    ...
    sa.Column('qa_max_retries', sa.INTEGER(), nullable=True),
    ...
    sa.Column('is_subdivided', sa.BOOLEAN(), nullable=False),
    sa.Column('status', sa.VARCHAR(length=20), nullable=False),
    ...
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'agent_type', 'version', name='uq_user_agent_version')
    )
    op.create_index(op.f('ix_system_prompts_agent_type'), 'system_prompts', ['agent_type'], unique=False)
    op.create_index(op.f('ix_system_prompts_is_active'), 'system_prompts', ['is_active'], unique=False)
    ...
    sa.Column('task_type', sa.VARCHAR(length=20), nullable=False),
    sa.Column('assigned_llm', sa.VARCHAR(length=100), nullable=True),
    sa.Column('status', sa.VARCHAR(length=20), nullable=False),
    sa.Column('worker_result', sa.TEXT(), nullable=True),
    ...
    sa.Column('snapshot_type', sa.VARCHAR(length=30), nullable=False),
    ...
    op.create_index(op.f('ix_memory_snapshots_milestone_id'), 'memory_snapshots', ['milestone_id'], unique=False)
    op.create_index(op.f('ix_memory_snapshots_session_id'), 'memory_snapshots', ['session_id'], unique=False)
    op.create_index(op.f('ix_memory_snapshots_snapshot_type'), 'memory_snapshots', ['snapshot_type'], unique=False)
    ...
    op.create_index(op.f('ix_llm_usage_logs_agent_type'), 'llm_usage_logs', ['agent_type'], unique=False)
    op.create_index(op.f('ix_llm_usage_logs_llm_model'), 'llm_usage_logs', ['llm_model'], unique=False)
    op.create_index(op.f('ix_llm_usage_logs_llm_provider'), 'llm_usage_logs', ['llm_provider'], unique=False)
    op.create_index(op.f('ix_llm_usage_logs_milestone_id'), 'llm_usage_logs', ['milestone_id'], unique=False)
    ...
    sa.Column('meta_prompter_model', sa.VARCHAR(length=100), nullable=True),
    ...
    sa.Column('prompt_strategy', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['milestone_id'], ['milestones.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_generated_prompts_milestone_id'), 'generated_prompts', ['milestone_id'], unique=False)

    # Create prompt_usage_history table
    op.create_table('prompt_usage_history',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('milestone_id', sa.UUID(), nullable=False),
    sa.Column('system_prompt_id', sa.UUID(), nullable=True),
    sa.Column('generated_prompt_id', sa.UUID(), nullable=True),
    sa.Column('final_prompt_hash', sa.VARCHAR(length=64), nullable=True),
    sa.Column('worker_llm', sa.VARCHAR(length=100), nullable=True),
    sa.Column('qa_passed', sa.BOOLEAN(), nullable=True),
    sa.Column('user_satisfaction', sa.INTEGER(), nullable=True),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['generated_prompt_id'], ['generated_prompts.id'], ),
    sa.ForeignKeyConstraint(['milestone_id'], ['milestones.id'], ),
    sa.ForeignKeyConstraint(['system_prompt_id'], ['system_prompts.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_prompt_usage_history_final_prompt_hash'), 'prompt_usage_history', ['final_prompt_hash'], unique=False)
    op.create_index(op.f('ix_prompt_usage_history_generated_prompt_id'), 'prompt_usage_history', ['generated_prompt_id'], unique=False)
    op.create_index(op.f('ix_prompt_usage_history_milestone_id'), 'prompt_usage_history', ['milestone_id'], unique=False)
    op.create_index(op.f('ix_prompt_usage_history_system_prompt_id'), 'prompt_usage_history', ['system_prompt_id'], unique=False)


def downgrade() -> None:
    # Drop tables in reverse order
    op.drop_index(op.f('ix_prompt_usage_history_system_prompt_id'), table_name='prompt_usage_history')
    op.drop_index(op.f('ix_prompt_usage_history_milestone_id'), table_name='prompt_usage_history')
    op.drop_index(op.f('ix_prompt_usage_history_generated_prompt_id'), table_name='prompt_usage_history')
    op.drop_index(op.f('ix_prompt_usage_history_final_prompt_hash'), table_name='prompt_usage_history')
    ...
    op.drop_index(op.f('ix_memory_snapshots_milestone_id'), table_name='memory_snapshots')
